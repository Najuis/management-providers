...
class City(Base):
    ...
    legal_person: Mapped[List["LegalPerson"]] = relationship(back_populates="city")
    legal_representative_information: Mapped[List["LegalRepresentativeInformation"]] = relationship(back_populates="city")
    general_information: Mapped[List["GeneralInformation"]] = relationship(back_populates="city")
